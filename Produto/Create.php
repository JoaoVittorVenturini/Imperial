            ...
            <form action="./Actions.php" method="post">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" name="id" placeholder="982739187311000">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" name="nome" placeholder="Call of Duty Warzone">
                    </div>
                </div>
                ...
                <div class="row row cols-2">
                    <div class="col">
                        ...
                        <input type="text" name="valor" placeholder="R$129,99">
                    </div>

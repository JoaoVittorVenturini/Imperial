        ...
        <div class="container grande text-center">
            ...
            include_once("../db/connectDB.php");
                ...
                while($row = $res->fetch_object()){
                    ...
                    <button onclick=\"if(confirm('Tem certeza que deseja excluir esse cadastro?')){location.href='./Actions.php&acao=excluir&id=".$row->id."'}else{false;}\" class='btn btn-danger'>Exclir</button> 
                    </div>";
                    print "</div>";
                }

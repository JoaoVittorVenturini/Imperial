            ...
            <form action="./salvarFuncionario.php" method="post">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" required name="id" placeholder="20220095">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label for="nome">Nome</label>
                        <input type="text" required name="nome" placeholder="Rodrigo Yuzo">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label for="email">E-mail</label>
                        <input type="email" required name="email" placeholder="rodrigo@exemplo.com">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label for="telefone">Telefone</label>
                        <input type="text" name="telefone" placeholder="(43) 99849-1976">
                    </div>
                    <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="password" required name="senha2" placeholder="•••••••••">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
